...
export const zostr = {
  ...
  nip01: {
    ...
    metadata: () =>
      z.catchall(
        z.object(nip01.nip01.metadata()._zod.def.shape),
        nip01.nip01.metadata()._zod.def.catchall as core.SomeType,
      ),
    ...
    metadataFields: {
      ...
      nip05: () => miniSchema(z.ZodMiniString, nip01.metadataFields.nip05()),
