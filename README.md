...
commit, the instant it landed upstream, and the SHA-256 of the document's text,
so an entry can be confirmed against the document rather than taken on trust.
It covers the NIPs above and the two specs behind
